...
CREATE TABLE IF NOT EXISTS Classroom(
	...
	Available BOOLEAN NOT NULL DEFAULT TRUE COMMENT '教室可用标志'
...
CREATE TABLE IF NOT EXISTS RoomSchedule(
	ID INT AUTO_INCREMENT PRIMARY KEY COMMENT '教室安排ID',
...
CREATE TABLE IF NOT EXISTS Application(
	...
	ReadFeedback BOOLEAN DEFAULT false COMMENT '管理员已读标志',
	UNIQUE(RoomID, ZhouCi, XingQi, SJieCi, EJieCi),
	FOREIGN KEY(UserID) REFERENCES User(ID) ON DELETE CASCADE,
	FOREIGN KEY(RoomID) REFERENCES Classroom(ID) ON DELETE CASCADE,
...
-- INSERT
INSERT INTO Semester VALUES(1,'2020~2021学年第二学期校历','2021-03-01',20);
...
INSERT INTO Classroom VALUES('C00001','xxxxx','sdlfj','jwioe','计算机学院','ld',1,60,true);
INSERT INTO Classroom VALUES('1#201','sdf','普通教室','北京路校区','abc','1',2,100,true);
INSERT INTO Classroom VALUES('1#202','sdf','多媒体教室','北京路校区','abc','1',2,50,true);
INSERT INTO Classroom VALUES('1#203','sdf','计算机教室','北京路校区','abc','1',2,50,true);
INSERT INTO Classroom VALUES('2#101','sdf','会议室','北京路校区','abc','2',1,60,true);
INSERT INTO Classroom VALUES('11#101','sdf','多媒体教室','枚乘路校区','计算机学院','11',1,50,true);
INSERT INTO Classroom VALUES('11#102','sdf','计算机教室','枚乘路校区','计算机学院','11',1,50,true);
INSERT INTO Classroom VALUES('11#103','sdf','计算机教室','枚乘路校区','计算机学院','11',1,50,true);
INSERT INTO Classroom VALUES('11#104','sdf','多媒体教室','枚乘路校区','计算机学院','11',1,50,true);
INSERT INTO Classroom VALUES('12#101','sdf','普通教室','枚乘路校区','计算机学院','12',1,100,true);
INSERT INTO Classroom VALUES('22#201','sdf','会议室','枚乘路校区','应用技术学院','22',2,60,true);
INSERT INTO Classroom VALUES('111#301','sdf','多媒体教室','萧湖校区','abc','111',3,50,true);
INSERT INTO Classroom VALUES('111#302','sdf','计算机教室','萧湖校区','abc','111',3,50,true);
INSERT INTO Classroom VALUES('123#301','sdf','普通教室','萧湖校区','abc','123',3,100,true);
INSERT INTO Classroom VALUES('222#301','sdf','会议室','萧湖校区','abc','222',3,60,true);
INSERT INTO Classroom VALUES('YFJ0101','sdf','阶梯教室','枚乘路校区','abc','逸夫楼',1,300,true);
INSERT INTO Classroom VALUES('YFJ0201','sdf','阶梯教室','枚乘路校区','abc','逸夫楼',2,300,true);
INSERT INTO Classroom VALUES('YFJ0202','sdf','阶梯教室','北京路校区','abc','逸夫楼',2,300,true);
INSERT INTO Classroom VALUES('YFJ0303','sdf','阶梯教室','萧湖校区','abc','逸夫楼',3,300,true);
...
INSERT INTO RoomSchedule(RoomID,UserID,ZhouCi,XingQi,SJieCi,EJieCi,Type) VALUES('11#101','U00003',15,3,7,9,'课表课程');
...
INSERT INTO Application(UserID,RoomID,ZhouCi,XingQi,SJieCi,EJieCi,Type,Purpose,ReviewerID,ReviewTime,Approval,ReviewContent) VALUES('U00001','11#101',15,1,1,2,'教学活动','给学生上课','A00001','2021-04-11 11:11:12',1,'通过，可以');
